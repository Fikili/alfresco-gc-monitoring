 ...
 */
package com.tieto.alfresco.monitoring.platformsample;
...
public class DemoComponentIT extends AbstractAlfrescoIT {
    ...
    public void testGetCompanyHome() {
        DemoComponent demoComponent = (DemoComponent) getApplicationContext().getBean("com.tieto.alfresco.monitoring.DemoComponent");
